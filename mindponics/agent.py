...
from . import prompt
from .sub_agents.water.agent import WaterQualityAgent
from .sub_agents.fish.agent import FishHealthAgent
from .sub_agents.plant.agent import PlantGrowthAgent
from .sub_agents.bacteria.agent import BacteriaAgent
from .sub_agents.environment.agent import EnvironmentAgent

MODEL = "gemini-1.5-flash-latest"

water_agent_instance = WaterQualityAgent(name="HydroGuardian", orchestrator_id="orchestrator")
